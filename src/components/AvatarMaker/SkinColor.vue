<template>
  <svg id='skincolor' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='360px'
    height='360px' viewBox='0 0 360 360' E='xMidYMid meet'>
    <g id='skin'>
      <path id='body' fill='#edb98a'
      ...
      <path id='neck' fill='#000000' fill-opacity='0.2'
