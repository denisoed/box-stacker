<template>
  <svg id='eyes' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='360px'
    height='360px' viewBox='0 0 360 360' E='xMidYMid meet'>
    <g id='e_default'>
    ...
    <g id='e_dizzy' style='display:none;'>
      <polygon fill='#000000' fill-opacity='0.7' stroke='#5F4A37' stroke-width='0.9'
        points='139,141 146,149 154,141 157,145 150,152 157,160 154,163 146,156 139,163 135,160 143,152 135,145 ' />
      <polygon fill='#000000' fill-opacity='0.7'
